...
<t:modal_sem_save nomeLabel="O que deseja fazer com a Reserva?" nome="DeletarReservaSem" genero="a">
	...
	<div class="col-xs-12 text-center" style="font-size:20px;">
			...
			<button class="btn btn-success" id="excluirReservaSemDup" data-dismiss="modal" >Duplicar</button>
		</div>
	</div>
</t:modal_sem_save>