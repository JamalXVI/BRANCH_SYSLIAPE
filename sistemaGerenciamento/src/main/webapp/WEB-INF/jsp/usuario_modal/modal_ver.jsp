...
<t:modal_sem_save nomeLabel="Visualizar Usuário" nome="VerUsuario" genero="o">
	<div class='row'>
		...
		id="dataNascimentoVer" nome="" nomeLabel="Data de Nascimento:" valorPadrao="" tipo="text"
		 editavel="1"></t:input>
		<t:input divCol="col-xs-12 col-md-6" 
		id="grupoVer" nome="" nomeLabel="Grupo:" valorPadrao="" tipo="text"
		 editavel="1"></t:input>
		 <t:input divCol="col-xs-12 col-md-6" 
		id="loginVer" nome="" nomeLabel="Login:" valorPadrao="" tipo="text"
		 editavel="1"></t:input>
